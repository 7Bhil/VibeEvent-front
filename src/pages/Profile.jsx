    ...
    return (
        <div className="p-10 max-w-5xl mx-auto">
            <div className="mb-12">
                ...
                <p className="text-slate-500 font-medium">Gérez votre identité et vos accès sur VibeEvent.</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white/5 border border-white/5 rounded-[32px] p-8 text-center relative overflow-hidden group">
                        ...
                        <div className="w-24 h-24 rounded-3xl bg-gradient-to-tr from-purple-600 to-blue-500 mx-auto mb-6 flex items-center justify-center text-3xl font-black shadow-2xl shadow-purple-500/20 relative z-10">
                            {user.name?.charAt(0)}
                        </div>
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <section className="bg-white/5 border border-white/5 rounded-[40px] p-10">
                        ...
                        {user.organization ? (
                            ...
                            <div className="text-center py-10">
                                <p className="text-slate-400 mb-6 font-medium">Vous n'appartenez à aucune organisation pour le moment.</p>
                                {user.role === 'attendee' ? (
                                    <div className="bg-blue-500/5 border border-blue-500/10 rounded-3xl p-8">
                                        ...
                                        {!requestSent ? (
                                            <button 
                                                ...
                                                className="bg-blue-600 hover:bg-blue-500 text-white font-black py-4 px-10 rounded-2xl text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-blue-500/20 transition-all flex items-center gap-3 mx-auto"
                                            >
                                    ...
                                    <button className="bg-white/5 text-white py-4 px-10 rounded-2xl text-[10px] font-black uppercase tracking-widest border border-white/5 hover:bg-white/10 transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-white/5 border border-white/5 rounded-[32px] p-8 opacity-40">
