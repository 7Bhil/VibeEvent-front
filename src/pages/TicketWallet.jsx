            ...
            <div className="flex-1">
                <div className="mb-10">
                    <h1 className="text-4xl font-black flex items-center gap-3">
                        <TicketIcon className="text-red-500" size={36} /> Mon Portefeuille
                    </h1>
                    ...
                    <div className="space-y-4">
                        {tickets.map(ticket => (
                            <div 
                                ...
                                className={cn(
                                    "bg-slate-100 border border-slate-200 rounded-[32px] p-6 flex flex-col md:flex-row gap-6 cursor-pointer hover:border-red-500/50 transition-all",
